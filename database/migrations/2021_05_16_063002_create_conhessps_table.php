...
class CreateConhesspsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('conhessps', function (Blueprint $table) {
            $table->unsignedBigInteger('id')->autoIncrement();
            $table->bigInteger('rank_id')->nullable();
            $table->bigInteger('conhessp_gl')->nullable();
            $table->bigInteger('conhessp_step')->nullable();
