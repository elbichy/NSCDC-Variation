...
class CreateConmessesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('conmesses', function (Blueprint $table) {
            $table->unsignedBigInteger('id')->autoIncrement();
            $table->bigInteger('rank_id')->nullable();
            $table->bigInteger('conmess_gl')->nullable();
            $table->bigInteger('conmess_step')->nullable();
